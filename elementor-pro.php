...
// --- BYPASS LOGIC START ---
update_option( 'elementor_pro_license_key', 'OFFICE-PRO-BYPASS-3340' );
update_option( '_elementor_pro_license_v2_data', [ 
    'timeout' => strtotime( '+1 year', current_time( 'timestamp' ) ), 
    'value' => json_encode( [ 
        'success' => true, 
        'license' => 'valid', 
        'expires' => '01.01.2030', 
        ...
        if ( strpos( $url, 'my.elementor.com/api/v2/licenses' ) !== false ) {
            return [
                ...
                'body'     => json_encode( [ 
                    ...
                    'license' => 'valid', 
                    'expires' => '01.01.2030',
                    'features' => ['pro_trial', 'theme-builder', 'popup', 'forms'] 
                ] )
            ];
        }
        return $pre;
